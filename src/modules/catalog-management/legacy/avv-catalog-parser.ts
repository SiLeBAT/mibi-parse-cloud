...
export class AVVCatalogParser {
    ...
    private getStandardData(catalog: KatalogInstance) {
        return {
            version: catalog.katalog.metadaten.versionsnummer.toString(),
            gueltigAb: this.extractDateFromGueltigAbField(
                catalog.katalog.metadaten.gueltigAb.toString()
            ),
            katalogName: catalog.katalog.metadaten.katalogname.name,
            katalogNummer: catalog.katalog.metadaten.katalognummer.toString(),
            facettenErlaubt: catalog.katalog.metadaten.facettenErlaubt,
            eintraege: catalog.katalog.eintragsTyp.eintraege
        };
    }
