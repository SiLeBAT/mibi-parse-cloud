...
export type SampleEntryV18Props<T> = {
    sample_id: T;
    sample_id_avv: T;
    partial_sample_id: T;
    pathogen_avv: T;
...
export class SampleEntryV18<T> extends Entity<SampleEntryV18Props<T>> {
    static create<T>(
        props: SampleEntryV18Props<T>,
        id?: EntityId
    ): SampleEntryV18<T> {
        const sampleEntry = new SampleEntryV18(props, id);
        return sampleEntry;
    }

    private constructor(props: SampleEntryV18Props<T>, id?: EntityId) {
        super(props, id);
    }
    get data(): SampleEntryV18Props<T> {
        return this.props;
    }
        ...
        for (const key in this.data) {
            switch (key) {
                ...
                default: {
                    ...
                    const entry: any =
                        this.data[key as keyof SampleEntryV18Props<T>];
