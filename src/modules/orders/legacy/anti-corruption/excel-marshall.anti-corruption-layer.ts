...
export class ExcelMarshallAntiCorruptionLayer {
            ...
            samples: order.sampleEntryCollection.map(
                (
                    ...
                    switch (version) {
                        ...
                        case '18':
                        default: {
                            data = this.getDataV18(
                                entry as SampleEntryV18<SampleEntryV18Tuple>
                            );
                            break;
                        }
                    }
    ...
    private getData(entry: SampleEntry<SampleEntryTuple>) {
        return {
            sample_id: {
    ...
    private getDataV18(entry: SampleEntryV18<SampleEntryV18Tuple>) {
        return {
            sample_id: {
                value: entry.data.sample_id.value,
                oldValue: entry.data.sample_id.oldValue,
