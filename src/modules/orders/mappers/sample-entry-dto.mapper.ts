...
export class SampleEntryDTOMapper extends Mapper {
    ...
    static toDTO<T>(
        ...
        return {
            sampleData: {
                ...
                additional_marks_avv: mapperFunction(
                    sampleEntry.data.additional_marks_avv
                ),
    ...
    static fromDTO<T>(
        ...
        const props: SampleEntryProps<T> = {
            ...
            sequence_id: mapperFunction(sample.sampleData.sequence_id),
            sequence_status: mapperFunction(sample.sampleData.sequence_status),
            ...
            additional_marks_avv: mapperFunction(
                sample.sampleData.additional_marks_avv
            ),
            control_program_avv: mapperFunction(
