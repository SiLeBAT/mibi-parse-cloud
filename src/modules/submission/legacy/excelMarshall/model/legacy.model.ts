...
export interface NRLService {
    getOptionalAnalysisFor(nrl: NRL_ID_VALUE): Promise<Partial<Analysis>>;
    getStandardAnalysisFor(nrl: NRL_ID_VALUE): Promise<Partial<Analysis>>;
}
...
interface AnnotatedSampleDataEntry {
    value: string;
    oldValue?: string;
}
...
export interface SampleSheetService {
    fromSampleSetToSampleSheet(sampleSet: SampleSet): Promise<SampleSheet>;
